...
class APIServices {
    companion object {
        ...
        var body = "client_id=7d2f26f6-2e67-4299-9abd-fbac27deff25&client_secret=rcI8Q~eugdoR2M0Yx8_gkTPqqyPyT.sn9ab3BdeF&grant_type=client_credentials&resource=https://alm.sandbox.operations.eu.dynamics.com"
        ...
        fun notcreate(context:Context): BookWebServices{
            ...
            val okHttpClient: OkHttpClient = OkHttpClient.Builder()
                ...
                .addInterceptor(
                    com.almufeed.technician.business.domain.utils.networkException.ConnectivityInterceptor(
                        context
                    )
                )
